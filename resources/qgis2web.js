...
map.getView().fit([-10340323.792455, -2317236.124354, -6431639.914064, 314643.633561], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Frecuencia Olas de Calor</h2>';
        return titleElement;
    })(),
